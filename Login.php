      ...
      Not yet a member? <a href="registration.php">Sign up</a>
                  ...
                  <form class="form-horizontal" method="post" action="Login.php">
                    ...
                    <div class="form-group has-feedback row">
                      ...
                      <div class="col-md-8">
                        <input type="text" class="form-control" name="username" id="inputUserName" placeholder="User Name" required>
                    ...
                    <div class="form-group row">
                      <div class="ml-md-auto col-md-9">
                        ...
                        <button type="submit" class="btn btn-group btn-default btn-animated" name="login_user">Log In <i class="fa fa-user"></i></button>
                        <ul class="space-top">
