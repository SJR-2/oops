...
<html dir="ltr" lang="zxx">
                ...
                <div class="header-top-first clearfix">
                  <ul class="social-links circle small clearfix hidden-sm-down">
                   ...
                   <ul class="list-inline hidden-sm hidden-xs">
                    <li><i class="fa fa-map-marker pr-5 pl-10"></i>Grand Rapids, MI</li>
 ...
 <header class="header  fixed    clearfix" >
      ...
      <!-- ================ -->
     <div class="banner dark-translucent-bg padding-bottom-clear" style="background-image:url('images/la.jpeg');background-position: 50% 32%; height: 50em;">
        <div class="container">
                ...
                <div class="form-block p-30 light-gray-bg border-clear">
                  ...
                  <form class="form-horizontal" method="post" action="registration.php">
                    <div class="form-group has-feedback row">
                      ...
                      <label for="inputName" class="col-md-3 control-label text-md-right col-form-label">User Name <span class="text-danger small">*</span></label>
                      <div class="col-md-8">
                        <input type="text" class="form-control" name="username" id="inputName" placeholder="User Name" value="<?php echo $username; ?>" required>
                    ...
                    <div class="form-group has-feedback row">
                      ...
                      <div class="col-md-8">
                        <input type="email" class="form-control" name="email" id="inputEmail" placeholder="Email" value="<?php echo $email; ?>" required>
                     ...
                     <div class="form-group has-feedback row">
                      ...
                      <div class="col-md-8">
                        <input type="password" name="password_1" class="form-control" id="inputPassword" placeholder="Password" required>
                        <i class="fa fa-lock form-control-feedback pr-4"></i>
                      </div>
                    </div>
                    <div class="form-group has-feedback row">
                      <label for="inputPassword_2" class="col-md-3 control-label text-md-right col-form-label">Confirm password <span class="text-danger small">*</span></label>
                      <div class="col-md-8">
                        <input type="password" name="password_2" class="form-control" id="inputPassword_2" placeholder="Confirm Password" required>
                        <i class="fa fa-lock form-control-feedback pr-4"></i>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <div class="ml-md-auto col-md-9">
                        <button type="submit" class="btn btn-group btn-default btn-animated" name="reg_user">Sign Up <i class="fa fa-check"></i></button>
                      </div>
                    </div>
                     <p>
