  ...
  <body class="front-page ">
    ...
    <div class="page-wrapper">
     <!-- header-container start -->
              ...
              <div class="col-xs-3 col-sm-6 col-md-9">
                ...
                <div class="header-top-first clearfix" >
                  <ul class="social-links circle small clearfix hidden-xs">
                    <li class="facebook"><a target="_blank" href="https://www.instagram.com/oops616/?hl=en"><i class="fa fa-instagram"></i></a></li>
                  </ul>
      ...
      <!-- banner start -->
      <!-- ================ -->
      <div class="banner dark-translucent-bg padding-bottom-clear" style="background-image:url('images/la.jpeg');background-position: 50% 32%; height: 23em;">
        <!-- section start -->
        <!-- ================ -->
        <div class="container">
          <div class="row justify-content-lg-center">
            <div class="col-lg-8 text-center space-bottom">
              <div class="title large_white">Oops616 Clothing(brand)</div>
              <div class="separator"></div>
              <p class="text-center lead">It's a lifestyle. This is your time. Your're in countrol. Show us your #Oops moment</p>
            </div>
          </div>
